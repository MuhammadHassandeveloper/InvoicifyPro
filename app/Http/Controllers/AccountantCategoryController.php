...
class AccountantCategoryController extends Controller
{
    public function index()
    {
        ...
        $data['categories'] = Category::where('user_id',$user_id)->get();
        return view('accountant.categories.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $categoryHtml = view('accountant.categories.partials.category_row', compact('category'))->render();
