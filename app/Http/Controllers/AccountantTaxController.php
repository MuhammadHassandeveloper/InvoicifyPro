...
class AccountantTaxController extends Controller
{
    public function index()
    {
        ...
        $data['taxes'] = Tax::with('country')->where('user_id',$user_id)->get();
        $data['countries'] = Country::where('status',1)->get();

        return view('accountant.taxes.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $taxHtml = view('accountant.taxes.partials.tax_row', compact('tax'))->render();
