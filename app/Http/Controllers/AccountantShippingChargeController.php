...
class AccountantShippingChargeController extends Controller
{
    public function index()
    {
        ...
        $data['shippingCharges'] = ShippingCharge::with('country')->where('user_id',$user_id)->get();
        $data['countries'] = Country::where('status',1)->get();
        return view('accountant.shipping_charges.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $shippingChargeHtml = view('accountant.shipping_charges.partials.shipping_charge_row', compact('shippingCharge'))->render();
