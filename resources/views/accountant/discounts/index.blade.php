    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create-discount-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('accountant.discounts.store') }}",
                    type: 'POST',
                    data: formData,
            ...
            $('#edit-discount-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('accountant.discounts.update', '') }}/" + discountId,
                    type: 'POST',
                    data: formData,
                    headers: {
        ...
        function editDiscount(id) {
            $.ajax({
                url: "{{ route('accountant.discounts.show', '') }}/" + id,
                type: 'GET',
                success: function(response) {
        ...
        function deleteDiscount(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('accountant.discounts.destroy', '') }}/" + id,
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function changeStatus(id, status) {
            $.ajax({
                url: '/accountant/discounts/' + id + '/status',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    status: status
