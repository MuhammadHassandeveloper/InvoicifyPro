    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create-category-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('accountant.categories.store') }}",
                    type: 'POST',
                    data: formData,
            ...
            $('#edit-category-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('accountant.categories.update', '') }}/" + categoryid,
                    type: 'POST',
                    data: formData,
                    headers: {
        ...
        function editCategory(id) {
            $.ajax({
                url: "{{ route('accountant.categories.show', '') }}/" + id,
                type: 'GET',
                success: function(response) {
        ...
        function deleteCategory(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('accountant.categories.destroy', '') }}/" + id,
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function changeStatus(id, status) {
            $.ajax({
                url: '/accountant/categories/' + id + '/status',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    status: status
