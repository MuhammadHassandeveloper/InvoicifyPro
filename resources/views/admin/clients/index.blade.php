...
@section('client-all-list-page','active')
@section('style')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-custom mb-2 nav-success mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @yield('client-all-list-page')" href="{{ url('/admin/clients') }}" role="tab" aria-selected="true">
                                        All
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link @yield('client-active-list-page')" href="{{ url('/admin/clients/active') }}" role="tab" aria-selected="false">
                                        Active
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @yield('disabled-client-list-page')" href="{{ url('/admin/clients/disabled') }}" role="tab" aria-selected="false">
                                        Disabled
                                    </a>
                                </li>
                                ...
                                <table id="DataTables_Table_0" class="table table-sm  dt-responsive align-middle table-hover table-bordered mb-0 dataTable no-footer dtr-inline collapsed">
                                    ...
                                    @foreach ($clients as $client)
                                        <tr id="client-{{ $client->id }}">
                                            <td>
                                                <a href="{{ route('admin.clients.edit',$client->id) }}" class="text-body align-middle fw-medium">
