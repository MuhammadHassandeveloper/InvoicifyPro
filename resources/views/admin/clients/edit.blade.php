    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="ml-3"><b>Edit Client</b></h4>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.clients.update', $client->id) }}" autocomplete="off" class="needs-validation was-validated" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                @include('admin.clients.partials.form')
                                <div class="hstack gap-2 mt-4">
                                    <button type="submit" class="btn btn-primary float-end" id="updateClient">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
