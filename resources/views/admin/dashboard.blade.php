...
@section('script')
    ...
    <script>
        // Products Status Count Column Chart
        var statusOptions = {
            chart: {
                height: 350,
            ...
            plotOptions: {
                bar: {
                    horizontal: false, // Set to false for a vertical column chart
                    columnWidth: '55%', // Adjust the width of the columns
                    endingShape: 'rounded' // Optional: Set the shape of the columns
                },
            },
            dataLabels: {
