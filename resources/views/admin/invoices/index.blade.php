    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('admin.invoices.create') }}" class="btn btn-primary">Create New</a>
            </div>
            <div class="row">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom mb-2 nav-success mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @yield('all-invoices-list-page')"
                                       href="{{ url('/admin/invoices') }}" role="tab" aria-selected="true">
                                        All
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @yield('unpaid-invoices-list-page')"
                                       href="{{ url('/admin/invoices/unpaid') }}" role="tab" aria-selected="false">
                                        UnPaid
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @yield('paid-invoices-list-page')"
                                       href="{{ url('/admin/invoices/paid') }}" role="tab" aria-selected="false">
                                        Paid
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @yield('void-invoices-list-page')"
                                       href="{{ url('/admin/invoices/void') }}" role="tab" aria-selected="false">
                                        Void
                                    </a>
                                </li>
